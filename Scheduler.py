...
class schedule_widget:
    ...
    def __init__(self,window):
        ...
        self.FoundLabel = Label(window,text='We found ')
        ...
        self.SearchInstruction = Label(window, text='To find your event just\nenter Month,Day,Year',font=('Times New Roman',10))
            ...
            for line in file:
                if reference in line:
                   # TODO: Make a label that does display the month,day,event,year variables
                    self.FoundLabel.grid(row=7,column=0)


    def delay(self):
        """
        This method is used to make sure that the user reads an error message in full
        :return:
        """
        TIME.sleep(1.5)